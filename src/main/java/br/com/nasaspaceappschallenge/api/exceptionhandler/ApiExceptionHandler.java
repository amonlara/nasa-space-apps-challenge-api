...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
	    ...
	    return hadleValidationInternal(ex, headers, status, request, ex.getBindingResult());
	}

	private ResponseEntity<Object> hadleValidationInternal(Exception ex, HttpHeaders headers, HttpStatus status,
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		ProblemType problemType = ProblemType.INVALID_BODY_REQUEST;
	...
	public ResponseEntity<Object> handleUserRegisterException(EntityValidationException ex, WebRequest request) {

		HttpStatus status =  HttpStatus.BAD_REQUEST;
		ProblemType type = ProblemType.ENTITY_VALIDATION;
		String detail = ex.getMessage();
